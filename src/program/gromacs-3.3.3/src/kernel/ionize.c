...
real powerSASE(real t, real *t_profile, real *inten_profile, size_t n_profile,int ephot, real rho)
{
...
void ionize(FILE *fp, t_mdatoms *md, char **atomname[], real t, t_inputrec *ir,
			...
			real *t_profile, real *inten_profile, size_t n_profile)
{
  static FILE  *xvg, *ion;
  ...
  real dt = t_profile[1] - t_profile[0];
  pt          = dt*powerSASE(t, t_profile, inten_profile, n_profile, ephot, rho);
  dq          = 0;
  nkdecay     = 0;
