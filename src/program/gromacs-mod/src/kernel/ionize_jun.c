...
size_t readProfile(real *t_profile,real *inten_profile)
{
    static FILE *fp = ffopen('profile.txt','r');
    if (fp == NULL)
    {
...
real powerSASE(real t,real *t_profile,real *inten_profile, size_t n_profile)
{
